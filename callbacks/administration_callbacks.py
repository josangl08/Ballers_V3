...
def register_administration_callbacks(app):
    ...
    @app.callback(
        ...
        [
            Input({'type': 'auto-hide-date', 'index': 'admin-filter-from-date'}, "value"),
    ...
    @app.callback(
        ...
        [
            ...
            State({'type': 'auto-hide-date', 'index': 'admin-new-session-date'}, "value"),
            ...
            State({'type': 'auto-hide-date', 'index': 'admin-filter-from-date'}, "value"),
    ...
    @app.callback(
        [
            ...
            Output({'type': 'auto-hide-date', 'index': 'admin-edit-session-date'}, "value"),
    ...
    @app.callback(
        ...
        [
            ...
            State({'type': 'auto-hide-date', 'index': 'admin-edit-session-date'}, "value"),
