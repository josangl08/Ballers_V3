...
class ETLController:
    ...
    def execute_full_pipeline(
        ...
        try:
            ...
            is_valid, validation_errors, validation_stats = self._execute_validate(clean_df, season)
            ...
            results["final_stats"] = {
                ...
                "data_quality_score": analysis["summary"]["quality_assessment"]["data_quality_score"]
            }
    ...
    def _execute_transform(self, df: pd.DataFrame, season: str) -> Tuple[pd.DataFrame, Dict]:
        """
    ...
    def _execute_validate(self, df: pd.DataFrame, season: str) -> Tuple[bool, List[str], Dict]:
        """
    ...
    def _execute_load(
        ...
        return self.loader.import_season_data(season, df, matching_results, column_mapping)
    ...
    def _execute_analyze(
        ...
        matching_report = self.analyzer.generate_matching_report(matching_results, season)
    ...
    def cleanup_and_reprocess(self, season: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            success, msg, results = self.execute_full_pipeline(season, force_reload=True)
