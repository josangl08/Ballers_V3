...
from models import Player, Session, SessionStatus, TestResult, User
...
class PlayerController:
    ...
    def get_current_player(
        self, player_id: Optional[int] = None, user_id: Optional[int] = None
    ) -> Optional[Player]:
        """
    ...
    def get_player_test_results(self, player: Player) -> List[TestResult]:
        ...
        return (
            ...
            .filter(TestResult.player_id == player.player_id)
            .order_by(TestResult.date.desc())
            .all()
        )

    def format_test_data_for_chart(
...
def get_player_profile_data(
    player_id: Optional[int] = None, user_id: Optional[int] = None
