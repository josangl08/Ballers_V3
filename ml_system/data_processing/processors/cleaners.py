...
class DataCleaners:
    ...
    def clean_null_values(
        value: Any, target_type: str = "string", empty_string_as_null: bool = True
    ) -> Any:
        """
        ...
        if isinstance(value, str):
            ...
            if value_clean in null_values or (
                empty_string_as_null and value_clean == ""
            ):
                return None
            return value_clean
    ...
    def clean_team_name(team_name: Any) -> Optional[str]:
        ...
        cleaned = DataCleaners.clean_null_values(
            team_name, target_type="string", empty_string_as_null=True
        )
    ...
    def clean_player_name(player_name: Any) -> Optional[str]:
        ...
        """
        cleaned = DataCleaners.clean_null_values(
            player_name, target_type="string", empty_string_as_null=True
        )
    ...
    def clean_percentage_value(value: Any) -> Optional[float]:
        ...
        return DataCleaners.clean_numeric_value(
            value, allow_negative=False, min_value=0.0, max_value=100.0
        )
    ...
    def clean_wyscout_id(wyscout_id: Any) -> Optional[int]:
        ...
        return DataCleaners.clean_integer_value(
            wyscout_id, allow_negative=False, min_value=1
        )

    @staticmethod
    def clean_dataframe_nulls(
        df: pd.DataFrame, columns_config: Optional[dict] = None
    ) -> pd.DataFrame:
        """
